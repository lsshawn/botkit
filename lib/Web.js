    ...
    controller.openSocketServer = function(server) {
        ...
        wss.on('connection', async function connection(ws, req) {
            ...
            if (botConfigs) {
                ...
                botConfigs = botConfigs.reduce((obj, item) => {
                    ...
                    let andOr = item.configKeys.reduce((a, k) => {
                        a[k.key] = k.andOr || ''
                        return a
                    }, {})
            ...
            var bot = controller.spawn(botConfigs);
            bot.ws = ws;
            bot.connected = true;
